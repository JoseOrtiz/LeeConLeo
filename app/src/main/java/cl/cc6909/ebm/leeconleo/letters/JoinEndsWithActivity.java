...
public class JoinEndsWithActivity extends JoinActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            is = getResources().getAssets().open("joinEndsWith/" + letter.toUpperCase() + ".txt");
    ...
    public void checkAnswer(int answer){
        if(picture[answer].getName().endsWith(letter)){
            pd.setGoodFeedback();
            pd.show();
